    ...
    <el-row class="imgaeWord imagecontent" :gutter="0">
      <el-col :span="10" class="title_left">
        <div v-for="(item, i) in data.shwoImg" :key="i">
          <img class="img-item-null" v-if="item.isborder" :src="item.src" alt="" />
        </div>
        <!-- //人体组织 -->
        <div :style="data.shwoImg[0].isborder ? 'display:block;' : 'display: none;'
          "></div>
      </el-col>
      <el-col :span="14">
        <div v-loading="loading" element-loading-text="Loading..." class="boxechart" id="tissuepie"
