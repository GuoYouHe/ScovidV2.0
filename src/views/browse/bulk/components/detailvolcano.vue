...
import { getbrowsego, getbrowsekegg, getbrowsevolcano, getbrowsevolcanotablesearch } from "@/api/browse";
          ...
          <el-tab-pane label="Volcano" name="volcano">
            <div v-loading="loading" element-loading-text="Loading..." class="echart-img">
              ...
              <div class="con-leftCon-titleone-pic" style="text-align: center;">
                <span>Figure 2.The volcano plot that shows the statistically significant DEGs between COVID-19 and control
                </span>
              </div>
            </div>
          </el-tab-pane>
